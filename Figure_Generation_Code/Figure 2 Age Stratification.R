...
# The code below is responsible for the analyses and plotting that produced Figure 2 of the paper. Any questions, 
...
young_children_micr_PCR_comp_model <- jags.model('Bayesian_Logit_Linear_Model.txt',   # OLD DATA
                                                 data = young_child_microscopy_PCR_comparison, n.chains = 1, inits = inits)

old_children_micr_PCR_comp_model <- jags.model('Bayesian_Logit_Linear_Model.txt',   # OLD DATA
                                               data = old_child_microscopy_PCR_comparison, n.chains = 1, inits = inits)

adult_micr_PCR_comp_model <- jags.model('Bayesian_Logit_Linear_Model.txt',   # NEW DATA
...
# Figure 2B Panel 1 Plotting - Microscopy Sensitivity Against PCR Prevalence for YOUNG CHILDREN - Raw Data & Modelled Relationship
...
# Figure 2B Panel 2 Plotting - Microscopy Sensitivity Against PCR Prevalence for OLD CHILDREN - Raw Data & Modelled Relationship
...
# Figure 2B Panel 3 Plotting - Microscopy Sensitivity Against PCR Prevalence for ADULTS - Raw Data & Modelled Relationship
