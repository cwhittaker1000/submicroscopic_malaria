...
Asia_microscopy_PCR_comparison <- list(prev_pcr = Asia$PCR_N_Positive, ## number positive by PCR,
                                      ...
                                      N = 75)               # Total sample data overall
...
East_Africa_microscopy_PCR_comparison <- list(prev_pcr = East_Africa$PCR_N_Positive, ## number positive by PCR,
                                      ...
                                      N = 122)            # Total sample data overall
                                      # __ zeroes not included, 161 zeroes included  
...
South_America_microscopy_PCR_comparison <- list(prev_pcr = South_America$PCR_N_Positive, ## number positive by PCR,
                                       ...
                                       N = 28) 
                                       # __ zeroes not included, 28 zeroes included  
...
West_Africa_microscopy_PCR_comparison <- list(prev_pcr = West_Africa$PCR_N_Positive, ## number positive by PCR,
                                                ...
                                                N = 67) 
                                                # __ zeroes not included, 77 zeroes included  
...
South_America_micr_PCR_comp_model <- coda.samples(South_America_micr_PCR_comp_model, params, 
                                         n.iter = 200000, thin = 70) # Model updating
...
# Calculating posterior densities for each Global Region's parameter estimates and comparing them graphically
Asia_beta <- density(as.array(Asia_micr_PCR_comp_model[, 1]))
East_Africa_beta <- density(as.array(East_Africa_micr_PCR_comp_model[, 1]))
South_America_beta <- density(as.array(South_America_micr_PCR_comp_model[, 1]))
West_Africa_beta <- density(as.array(West_Africa_micr_PCR_comp_model[, 1]))

plot(South_America_beta, col = "blue", ylim = c(0, 10), xlim = c(-0.5, 0.9), main = "Beta")
polygon(Asia_beta, col = adjustcolor("black", 0.4), border = "black", lwd = 2)
polygon(East_Africa_beta, col = adjustcolor("green", 0.4), border = "green", lwd = 2)
polygon(West_Africa_beta, col = adjustcolor("red", 0.4), border = "red", lwd = 2)
polygon(South_America_beta, col = adjustcolor("blue", 0.4), border = "blue", lwd = 2)
legend(0.4, 9, legend=c("Asia", "East Africa", "South America", "West Africa"), col=c("black", "green", "blue", "red"), lty=1, cex=0.8, lwd = 2)

Asia_delt <- density(as.array(Asia_micr_PCR_comp_model[, 2]))
East_Africa_delt <- density(as.array(East_Africa_micr_PCR_comp_model[, 2]))
South_America_delt <- density(as.array(South_America_micr_PCR_comp_model[, 2]))
West_Africa_delt <- density(as.array(West_Africa_micr_PCR_comp_model[, 2]))

plot(South_America_delt, col = "blue", ylim = c(0, 6), xlim = c(-4, 0), main = "Delta")
polygon(Asia_delt, col = adjustcolor("black", 0.4), border = "black", lwd = 2)
polygon(East_Africa_delt, col = adjustcolor("green", 0.4), border = "green", lwd = 2)
polygon(West_Africa_delt, col = adjustcolor("red", 0.4), border = "red", lwd = 2)
polygon(South_America_delt, col = adjustcolor("blue", 0.4), border = "blue", lwd = 2)
legend(-4, 5.5, legend=c("Asia", "East Africa", "South America", "West Africa"), col=c("black", "green", "blue", "red"), lty=1, cex=0.8, lwd = 2)
...
# Checking the minimum and maximum values of each continent's data for purpose of plotting
min(Asia$PCR_Prev)
max(Asia$PCR_Prev)

min(East_Africa$PCR_Prev)
max(East_Africa$PCR_Prev)

min(West_Africa$PCR_Prev)
max(West_Africa$PCR_Prev)

min(South_America$PCR_Prev)
max(South_America$PCR_Prev)
...
exp(Asia_fitted_logit_microscopy)
...
lines(East_Africa_values, East_Africa_fitted_microscopy, col = "green3", lwd = 3)
...
plot(East_Africa$PCR_Prev, East_Africa$Micro_Prev/East_Africa$PCR_Prev, xlim = c(0, 1), ylim = c(0, 1), pch = 20, col = "green3",
     xlab = "PCR Prevalence", ylab = "Slide Prevalence")
lines(PCR_prevalence_East_Africa, East_Africa_fitted_microscopy/PCR_prevalence_East_Africa, col = "green3", lwd = 3)

East_Africa_data_values <- seq(0,0.92,0.001)
...
South_America_data_values <- seq(0,0.45,0.001)
...
# Actually = lower because doing the 1 -
South_America_data_sensitivity_upper <- South_America_data_credible_upper_sens / South_America_data_values

# Actually = upper because doing the 1 -
South_America_data_sensitivity_lower <- South_America_data_credible_lower_sens / South_America_data_values
...
polygon(x = c(South_America_data_values, rev(South_America_data_values)), 
        ...
        col = adjustcolor("blue", alpha.f = 0.5), border = NA)
lines(PCR_prevalence_East_Africa, East_Africa_fitted_microscopy/PCR_prevalence_East_Africa, 
      col = adjustcolor("green3", alpha.f = 0.3), lwd = 3)
lines(PCR_prevalence_West_Africa, West_Africa_fitted_microscopy/PCR_prevalence_West_Africa, 
      col = adjustcolor("red", alpha.f = 0.3), lwd = 3)
lines(PCR_prevalence_Asia, Asia_fitted_microscopy/PCR_prevalence_Asia, 
...
West_Africa_data_values <- seq(0.008,0.97,0.001)
...
# Actually = lower because doing the 1 -
West_Africa_data_sensitivity_upper <- West_Africa_data_credible_upper_sens / West_Africa_data_values

# Actually = upper because doing the 1 -
West_Africa_data_sensitivity_lower <- West_Africa_data_credible_lower_sens / West_Africa_data_values
...
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), pch = 1, cex = 0.1,
     xlab = "PCR Prevalence", ylab = "Slide Prevalence")
lines(PCR_prevalence_East_Africa, East_Africa_fitted_microscopy/PCR_prevalence_East_Africa, 
      col = adjustcolor("green3"), lwd = 3)
lines(PCR_prevalence_West_Africa, West_Africa_fitted_microscopy/PCR_prevalence_West_Africa, 
      col = adjustcolor("red"), lwd = 3)
lines(PCR_prevalence_Asia, Asia_fitted_microscopy/PCR_prevalence_Asia, 
      col = adjustcolor("black"), lwd = 3)
lines(PCR_prevalence_South_America, South_America_fitted_microscopy/PCR_prevalence_South_America, 
      col = adjustcolor("blue"), lwd = 3)
